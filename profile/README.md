...
This org is the primary location for developing and evolving curriculum content of the [Deep Dive Java Enterprise & Android Mobile bootcamp](https://deepdivecoding.com/java-android/). Much of the curriculum is not publicly available: access to and use of that content is restricted to sbootcamp instructors and participants. However, there are links below to syllabus and other program overview content, and to reference materials used in the bootcamp (most developed internally, but some external resources as well).
...
- [Capstone project](https://ddc-java.github.io/capstone-project)
- [Personal Android project](https://ddc-java.github.io/personal-android-project)
...
- [Java Basics](https://ddc-java.github.io/java-basics)
    - [Timeline](https://ddc-java.github.io/java-basics/timeline/)
    - [Tools](https://ddc-java.github.io/java-basics/tools/)
    - [Building Blocks](https://ddc-java.github.io/java-basics/building-blocks/)
    - [Arrays](https://ddc-java.github.io/java-basics/arrays/)
    - [Methods](https://ddc-java.github.io/java-basics/methods/)
    - [Classes](https://ddc-java.github.io/java-basics/classes/)
    - [Packages](https://ddc-java.github.io/java-basics/packages/)
- [Style guide](https://ddc-java.github.io/style-guide/)

#### Intermediate concepts, practices, & tutorials
...
#### Posters & quick references 

- [Primitive & wrapper types](https://ddc-java.github.io/library/documents/Java%20Primitives.pdf)
- [Operators](https://ddc-java.github.io/library/documents/Java%20Operators.pdf)
- [Common lettercasing styles](https://ddc-java.github.io/library/documents/Casing.pdf)
- [`String`, `StringBuilder`, `StringBuffer`](https://ddc-java.github.io/library/documents/Java%20Strings.pdf)
- [Collections framework](https://ddc-java.github.io/library/documents/Java%20Collections%20Framework.pdf)
- [Android application architecture](https://ddc-java.github.io/library/documents/Android%20Application%20Architecture.pdf)
...
- [Using Git in a team project (without losing your sanity)](https://paper.dropbox.com/doc/Using-Git-in-a-team-project-without-losing-your-sanity--CJ~JP0iQqLTWkD5e0i2eceOwAQ-IX5NtyjPDfCkG16GnYhlQ)
- [Material Design](https://m3.material.io/)

#### References

- [Junit 5 User guide](https://junit.org/junit5/docs/current/user-guide/)
- [Regular expressions reference](https://www.regular-expressions.info/refflavors.html)

#### Tutorials & online tools
  
- [RegexOne](https://regexone.com/)
- [RegexPlanet](https://www.regexplanet.com/advanced/java/index.html)
